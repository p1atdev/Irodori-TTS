...
| `use_character_condition`, `character_*` fields | Enable Character Reference image conditioning, including image encoder/projector settings and optional summary/duration-split character states. |
