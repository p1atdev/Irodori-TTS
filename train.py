    ...
    *,
    ...
    def _allowed_missing(key: str) -> bool:
        return (
            ...
            or (allow_character_missing and is_character_only_parameter(key))
...
def _apply_base_initialization(
    ...
    *,
    ...
    if mode == "checkpoint":
        ...
        upgrade_character = current_has_character and not checkpoint_has_character
        upgrade_duration = current_has_duration and not checkpoint_has_duration
        if upgrade_caption or upgrade_character or upgrade_duration:
            ...
            validate_checkpoint_upgrade_partial_load(
                ...
                allow_character_missing=upgrade_character,
                allow_duration_missing=upgrade_duration,
                allow_speaker_extra=upgrade_caption or upgrade_character,
            )
        else:
